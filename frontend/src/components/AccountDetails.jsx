        ...
        <div className="container mt-4">
            <div className="card shadow-sm">
                <div className="card-body">
                    <h5 className="card-title text-center mb-3">Account Details</h5>
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item"><strong>State:</strong> {props.state}</li>
                        <li className="list-group-item"><strong>Zip:</strong> {props.zip}</li>
                    </ul>
                </div>
            </div>
        </div>
