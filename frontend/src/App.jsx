...
const router = createBrowserRouter(
	createRoutesFromElements(
		<Route path="/" element={<MainLayout />}>
			...
			<Route path="/request-help/status" element={<HomeownerApplicationStatus />}></Route>

			<Route path="/create-volunteer" element={<CreateVolunteer />}></Route>
			<Route path="/create-volunteer/confirm" element={<ConfirmVolunteer />}></Route>

			<Route path="/homeowner-requests" element={<HomeownerRequests />}></Route>
			<Route path="/homeowner-requests/request-details" element={<RequestDetails />}></Route>
			...
			<Route path="/applyVolunteer/status" element={<VolunteerApplicationStatus />}></Route>

			<Route path="/assignVolunteers" element={<AssignVolunteer />}></Route>
			<Route path="/volunteer/jobs" element={<VolunteerJobs />}></Route>
			<Route path="/volunteer/changePassword" element={<VolunteerPasswordChange />}></Route>
			<Route path="/volunteer/resetPassword" element={<VolunteerPasswordReset />}></Route>
			<Route path="/volunteers" element={<Volunteers />}></Route>
			<Route path="/volunteers/volunteer-details" element={<VolunteerDetails />}></Route>
