        ...
        <div style={{ margin: "5px" }}>
            <form onSubmit={formSubmitted} className="row g-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" name="firstName" id="firstName" value={formData.firstName} onChange={handleChange} required />
                </div>
                <div className="col-md-6">
                    <label htmlFor="lastName" className="form-label">Last Name</label>
                    <input type="text" className="form-control" name="lastName" id="lastName" value={formData.lastName} onChange={handleChange} required />
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                    ...
                    <input type="tel" className="form-control" name="phone" id="phone" placeholder="" value={formData.phone} onChange={handleChange} required />
                </div>
                <div className="col-12">
                    <label htmlFor="address_1" className="form-label">Address</label>
                    <input type="text" className="form-control" name="address_1" id="address_1" placeholder="1234 Main St" value={formData.address_1} onChange={handleChange} required />
                </div>
                <div className="col-12">
                ...
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" name="city" id="city" value={formData.city} onChange={handleChange} required />
                </div>
                <div className="col-md-4">
                    <label htmlFor="state" className="form-label">State</label>
                    <select id="state" name="state" className="form-select" placeholder="Choose..." value={formData.state} onChange={handleChange} required >
                ...
                <div className="col-md-2">
                    ...
                    <input type="number" className="form-control" name="zip" id="zip" value={formData.zipCode} onChange={handleChange} required />
                </div>
                <div className="col-12">
                    I need help with...
                    <div style={{ margin: "0px 0px 0px 20px" }}>
                        ...
                        <div className="form-check">
                            <input
                                ...
                                id="helpYard"
                                value="yardCleanup"
                                checked={formData.helpType.includes('yardCleanup')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange} />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                checked={formData.helpType.includes('interiorCleanup')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange}
                            />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                checked={formData.helpType.includes('emotionalSupport')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange}
                            />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                checked={formData.helpType.includes('cleaningSupplies')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange}
                            />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                id="helpWater"
                                value="cleanWater"
                                checked={formData.helpType.includes('cleanWater')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange}
                            />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                id="helpFood"
                                value="emergencyFood"
                                checked={formData.helpType.includes('emergencyFood')}
                                type="checkbox"
                                name="inputHelpType"
                                onChange={handleChange}
                            />
                        ...
                        <div className="form-check">
                            <input
                                ...
                                onClick={toggleOther}
                            />
                            <label id="otherLabel" className="form-check-label" htmlFor="other">Other</label>
                            <input type="text" name="other" id="other" style={{ display: "none" }} placeholder="Other" onChange={handleChange} />
                        </div>
                    </div>
                </div>
                <div>
