...
const VolunteerForm = () => {
	...
	useEffect(() => {
		//checkbox executes faster than the formData updates so it needs to be checked seperately
	...
	return (
		<div className="container mt-5">
			<div className="text-center mt-4">
				<h1 className="display-5 text-primary">Apply to Volunteer</h1>
			</div>
			...
			>
				...
				>
						...
						<div className="card-body px-4">
							<div className="row">
								<input
									...
									name="streetAddress1"
									className={`form-control ${
										formValidity.streetAddress1 === null
											? ""
					...
					<div
						className={`${styles.cardParent1} card rounded-3 shadow-sm m-2`}
					>
						<div className="card-header">Areas of Help:</div>
						<div className="card-body">
							<div className="row px-2">
								<div className={`card col-md-6 p-2`}>
									<div
										className={`${
											formValidity.areasOfHelp === null
												? ""
					...
					<button
						type="submit"
						className="text-center my-3 btn btn-primary"
